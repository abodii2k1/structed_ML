#!/bin/bash
#SBATCH --job-name=structml_partialft_relstack_k2
#SBATCH --output=logs/partialft_relstack_k2_%j.out
#SBATCH --error=logs/partialft_relstack_k2_%j.err
...
#   sbatch run_partialfinetune_relstack_k2.sh
...
echo "================================================"
echo "STRUCTML PARTIAL LLM FINE-TUNE: rel-stack (k=2)"
echo "================================================"
...
python hpc_partial_finetune.py rel-stack --k 2
EXIT_CODE=$?

echo ""
echo "================================================"
echo "PARTIAL LLM FINE-TUNE rel-stack k=2 COMPLETE - exit code $EXIT_CODE"
